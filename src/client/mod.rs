    ...
    C: Has<XSpanIdString>  + Clone + Send + Sync + 'static,
{
        ...
        context: &C) -> Result<GetIndexResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                ...
                let body = serde_json::from_str::<models::GetIndex200Response>(body)
                    .map_err(|e| ApiError(format!("Response body did not match the schema: {}", e)))?;


                Ok(GetIndexResponse::Status200
                    (body)
                )
            }
            code => {
        ...
        context: &C) -> Result<ItemsGetResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                ...
                let body = str::from_utf8(&body)
                    .map_err(|e| ApiError(format!("Response was not valid UTF8: {}", e)))?;
                let body = serde_json::from_str::<Vec<models::ItemsGet200ResponseInner>>(body)
                    .map_err(|e| ApiError(format!("Response body did not match the schema: {}", e)))?;


                Ok(ItemsGetResponse::Status200
                    (body)
                )
            }
            code => {
    ...
    async fn items_post(
        &self,
        param_items_post_request: models::ItemsPostRequest,
        context: &C) -> Result<ItemsPostResponse, ApiError>
    {
        ...
        // Consumes basic body
        // Body parameter
        let body = serde_json::to_string(&param_items_post_request).expect("impossible to fail to serialize");
        *request.body_mut() = Body::from(body);
        ...
        match response.status().as_u16() {
            201 => {
                ...
                let body = str::from_utf8(&body)
                    .map_err(|e| ApiError(format!("Response was not valid UTF8: {}", e)))?;
                let body = serde_json::from_str::<models::ItemsPost201Response>(body)
                    .map_err(|e| ApiError(format!("Response body did not match the schema: {}", e)))?;


                Ok(ItemsPostResponse::Status201
                    (body)
                )
            }
            code => {
        ...
        context: &C) -> Result<ItemsIdGetResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                ...
                let body = str::from_utf8(&body)
                    .map_err(|e| ApiError(format!("Response was not valid UTF8: {}", e)))?;
                let body = serde_json::from_str::<models::ItemsGet200ResponseInner>(body)
                    .map_err(|e| ApiError(format!("Response body did not match the schema: {}", e)))?;


                Ok(ItemsIdGetResponse::Status200
                    (body)
                )
            }
            code => {
    ...
    async fn items_id_put(
        &self,
        param_id: i32,
        param_items_id_put_request: models::ItemsIdPutRequest,
        context: &C) -> Result<ItemsIdPutResponse, ApiError>
    {
        ...
        // Consumes basic body
        // Body parameter
        let body = serde_json::to_string(&param_items_id_put_request).expect("impossible to fail to serialize");
        *request.body_mut() = Body::from(body);
        ...
        match response.status().as_u16() {
            200 => {
                ...
                let body = str::from_utf8(&body)
                    .map_err(|e| ApiError(format!("Response was not valid UTF8: {}", e)))?;
                let body = serde_json::from_str::<models::ItemsIdPut200Response>(body)
                    .map_err(|e| ApiError(format!("Response body did not match the schema: {}", e)))?;


                Ok(ItemsIdPutResponse::Status200
                    (body)
                )
            }
            code => {
