...
impl<C> Api<C> for Server<C> where C: Has<XSpanIdString> + Send + Sync
{
    ...
    {
        info!("get_index() - X-Span-ID: {:?}", context.get().0.clone());
    ...
    {
        info!("items_get() - X-Span-ID: {:?}", context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("items_post({:?}) - X-Span-ID: {:?}", items_post_request, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("items_id_delete({}) - X-Span-ID: {:?}", id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("items_id_get({}) - X-Span-ID: {:?}", id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("items_id_put({}, {:?}) - X-Span-ID: {:?}", id, items_id_put_request, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
